...
class Keys {
  ...
  static const onboardingAlreadyHaveAccountButton = Key(
    'onboarding_already_have_account_button',
  );
  ...
  static const signUpShowHidePasswordButton = Key(
    'sign_up_show_hide_password_button',
  );
  ...
  static const signInShowHidePasswordButton = Key(
    'sign_in_show_hide_password_button',
  );
  ...
  static const statsPageBottomAppBarItem = Key(
    'stats_page_bottom_app_bar_item',
  );
  static const walletPageBottomAppBarItem = Key(
    'wallet_page_bottom_app_bar_item',
  );
