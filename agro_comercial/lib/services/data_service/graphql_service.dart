...
class GraphQLService implements DataService<Map<String, dynamic>> {
  ...
  Future<GraphQLService> init() async {
    final HttpLink httpLink = HttpLink(const Environment().graphqlEndpoint);
    ...
    _client = GraphQLClient(
      ...
      defaultPolicies: DefaultPolicies(
        mutate: Policies(fetch: FetchPolicy.noCache, error: ErrorPolicy.ignore),
        query: Policies(fetch: FetchPolicy.noCache, error: ErrorPolicy.ignore),
      ),
  ...
  Future<Map<String, dynamic>> create({
    ...
    try {
      final options = MutationOptions(variables: params, document: gql(path));
  ...
  Future<Map<String, dynamic>> read({
    ...
    try {
      final options = QueryOptions(variables: params, document: gql(path));
  ...
  Future<Map<String, dynamic>> delete({
    ...
    try {
      final options = MutationOptions(document: gql(path), variables: params);
